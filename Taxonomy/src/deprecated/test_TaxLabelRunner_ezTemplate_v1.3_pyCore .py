...
workingUD = os.getcwd()+"\\testdata\\"
outUD = os.getcwd()+"\\Output\\"
...
if RunControl['Nodes']:
    ...
    ifn = 'gi-txid_test-giList.txt' #this file has all the taxID's I care about at this time
    ...
    OFN = FA.path([outUD,'nrTaxNeighborhood.txt'],fileType = 'tab') #This file describes the Taxonomic Neighborhood
    OFN.outDB(outLst)
