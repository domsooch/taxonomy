...
MODE='Specific'#MODE = 'InCommon'#MODE='Specific'
root = 'SpecificLeptospira-%0.2f'%HIT_THRESHOLD
...
fnLst = [['BO_InCommonintervals_Lepto-v-bactrefseq_W15.txt', 'InCommonintervals_Leptospira-0.30.fasta'] for f in range(1,7,1)]
