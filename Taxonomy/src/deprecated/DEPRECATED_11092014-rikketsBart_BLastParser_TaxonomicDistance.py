...
if RunControl['prep_taxneigh']:
    ...
    for t in TaxDB.keys():
        TaxDB[t].RecordSpeciesIndex(species_index_Lst)
...
if RunControl['ProcessBlastRuns']:
    ...
    root = 'Leptospira-%0.2f'%HIT_THRESHOLD
    ...
    for f in range(1,7,1):
        i = 0
        bo_fn ='%i-BO_Lepto-vs-Lepto_W15.txt'%f
        bi_fn = '%i-leptospira_genus.fasta'%f
